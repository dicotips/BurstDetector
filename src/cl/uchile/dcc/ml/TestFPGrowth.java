...
public class TestFPGrowth {
  ...
  public static void main(String[] args) throws Exception {
    ...
    List<Map.Entry<Set<String>, Double>> result_filtered = FPGrowthGenerator.frequenItemSets(itemsetList);
    ...
    /*
    TUtilsDescriber.cleanZiptTail(itemsetList, prop);
    List<FPGrowthResult> results = new FPGrowthGenerator().apply(itemsetList);
    
    int i = 1;
    HashSet<String> terms = new HashSet<>();
    for (FPGrowthResult result : results) {
      boolean flag1 = false;
      for (String term1 : result.premise) {
        flag1 = flag1 || terms.contains(term1);
      }
      
      boolean flag2 = false;
      for (String term2 : result.consequence) {
        flag2 = flag2 || terms.contains(term2);
      }
    ...
    /*
    List<Map.Entry<Set<String>, Double>> result_filtered = Apriori.frequenItemSets(itemsetList);
